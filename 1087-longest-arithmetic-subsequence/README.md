<h2><a href="https://leetcode.com/problems/longest-arithmetic-subsequence">1087. Longest Arithmetic Subsequence</a></h2><h3>Medium</h3><hr><p>Given an array <code>self</code> of integers, return <em>the length of the longest arithmetic subsequence in</em> <code>self</code>.</p>
...
<pre>
<strong>Input:</strong> self = [3,6,9,12]
...
<pre>
<strong>Input:</strong> self = [9,4,7,2,10]
...
<pre>
<strong>Input:</strong> self = [20,1,15,3,10,5,8]
<strong>Output:</strong> 4
...
<ul>
	<li><code>2 &lt;= self.length &lt;= 1000</code></li>
	<li><code>0 &lt;= self[i] &lt;= 500</code></li>
</ul>
